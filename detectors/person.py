...
# The separator comes from field_syntax, so this detector accepts the same
# spellings as every other labelled field. It used to spell out its own
# "colon or whitespace", which silently dropped the equals sign: 姓名=张伟 was
# missed while 病历号=ZY1 was caught, with no reason a caller could see.
